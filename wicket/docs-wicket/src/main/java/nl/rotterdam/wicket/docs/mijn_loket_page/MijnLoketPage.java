...
public class MijnLoketPage extends RotterdamBasePage {
    ...
    public List<UtrechtLinkListRecord<? extends IRequestablePage>> linkListLinks;
    public List<UtrechtBreadcrumbNavRecord<? extends IRequestablePage>> breadcrumbNavLinks;
