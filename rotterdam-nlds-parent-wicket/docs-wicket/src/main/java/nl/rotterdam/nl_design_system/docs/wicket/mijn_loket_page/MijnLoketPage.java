...
public class MijnLoketPage extends RotterdamBasePage {
    ...
    private static final List<RdSideNavRecord> sideNavRecords = List.of(
        new RdSideNavRecord(
    ...
    private final List<RdLinkListRecord<? extends IRequestablePage>> linkListLinks = List.of(
    ...
    private final List<RdBreadcrumbNavRecord<? extends IRequestablePage>> breadcrumbNavLinks = List.of(
    ...
    protected void onInitialize() {
        super.onInitialize();
        pageBody.add(new RdSideNavPanel("sideNav", sideNavRecords));

        pageBody.add(new RdBreadcrumbNavPanel("breadcrumbNav", this.breadcrumbNavLinks));
        pageBody.add(new RdPreserveDataLabel("name", Model.of("mevrouw Van Bergenhenegouwen")));
