...
public class UtrechtHeadingBehavior extends Behavior {
    ...
    public static final CssReferenceHeaderItem UTRECHT_HEADING_1_HEADER_ITEM = cssReferenceHeaderItem(
        UtrechtHeadingBehavior.class,
        "@utrecht/heading-1-css/dist/index.css"
    );
    public static final CssReferenceHeaderItem UTRECHT_HEADING_2_HEADER_ITEM = cssReferenceHeaderItem(
        UtrechtHeadingBehavior.class,
        "@utrecht/heading-2-css/dist/index.css"
    );
    public static final CssReferenceHeaderItem UTRECHT_HEADING_3_HEADER_ITEM = cssReferenceHeaderItem(
        UtrechtHeadingBehavior.class,
        "@utrecht/heading-3-css/dist/index.css"
    );
    public static final CssReferenceHeaderItem UTRECHT_HEADING_4_HEADER_ITEM = cssReferenceHeaderItem(
        UtrechtHeadingBehavior.class,
        "@utrecht/heading-4-css/dist/index.css"
    );
    public static final CssReferenceHeaderItem UTRECHT_HEADING_5_HEADER_ITEM = cssReferenceHeaderItem(
        UtrechtHeadingBehavior.class,
        "@utrecht/heading-5-css/dist/index.css"
    );
    public static final CssReferenceHeaderItem UTRECHT_HEADING_6_HEADER_ITEM = cssReferenceHeaderItem(
        UtrechtHeadingBehavior.class,
