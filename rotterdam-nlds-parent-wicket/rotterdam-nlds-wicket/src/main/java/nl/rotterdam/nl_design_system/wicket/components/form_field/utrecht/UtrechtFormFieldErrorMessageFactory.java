...
import nl.rotterdam.nl_design_system.wicket.components.form_field_error_message.utrecht.UtrechtFormFieldErrorMessageBehavior;
...
public enum UtrechtFormFieldErrorMessageFactory {
    ...
    public static Component createErrorMessageLabel(String id, Component componentWithFeedback) {
        ...
        return new Label(id, model).setOutputMarkupId(true).add(UtrechtFormFieldErrorMessageBehavior.INSTANCE);
    }

    public static Component createErrorMessageLabel(String id) {
        return new Label(id).setOutputMarkupId(true).add(UtrechtFormFieldErrorMessageBehavior.INSTANCE);
    }
}
