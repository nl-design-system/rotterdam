...
import static nl.rotterdam.nl_design_system.wicket.components.form_field_label.RdFormFieldLabelCss.CHECKED;
import static nl.rotterdam.nl_design_system.wicket.components.form_field_label.RdFormFieldLabelCss.DISABLED;
...
public class RdFormFieldLabelBehavior extends TagNameClassComponentBehavior<Component> {
    ...
    @Nullable
    private IModel<@Nullable Boolean> isCheckedModel;
     ...
     */
    public RdFormFieldLabelBehavior(RdFormFieldLabelCheckableInputType type, IModel<@Nullable Boolean> isCheckedModel) {
        super("label", BASE, type.classNames);
        this.isCheckedModel = isCheckedModel;
        addHeaderItem(CSS);
    }
    ...
    protected List<CssClassNames> customizeComponentAndReturnClasses(Component component, ComponentTag tag) {
        ...
        if ((componentLabelIsFor != null && !componentLabelIsFor.isEnabledInHierarchy()) || !component.isEnabledInHierarchy()) {
            classNames.add(DISABLED);
        }
        
        if (isCheckedModel != null && Boolean.TRUE.equals(isCheckedModel.getObject())) {
            classNames.add(CHECKED);
        }
