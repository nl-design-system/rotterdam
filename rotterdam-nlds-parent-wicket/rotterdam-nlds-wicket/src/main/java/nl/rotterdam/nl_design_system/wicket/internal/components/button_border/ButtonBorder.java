...
/**
 * <p>
 * A {@link Button} that can also be used as a {@link Border}, with the following limitations:
 * </p>
 * <ul>
...
public abstract class ButtonBorder extends Button implements IComponentResolver, IQueueRegion {
    ...
    public ButtonBorder(String id, @Nullable IModel<@Nullable String> model) {
        super(id, model);
    ...
    @Override
    public ButtonBorder add(final Component ... children) {
    ...
    @Override
    public ButtonBorder addOrReplace(final Component ... children) {
        for (Component component : children) {
            if (component == body) {
    ...
    @Override
    public ButtonBorder remove(final Component component) {
        if (component == body) {
            // in this case we do not want to redirect to body
            // container but to border's old remove.
    ...
    @Override
    public ButtonBorder remove(final String id) {
    ...
    @Override
    public ButtonBorder removeAll() {
        getBodyContainer().removeAll();
        return this;
    }

    @Override
    public ButtonBorder replace(final Component replacement) {
    ...
    public ButtonBorder addToBorder(final Component... children) {
        super.add(children);
        return this;
    }

    @Override
    public ButtonBorder queue(Component... components) {
        throw new IllegalStateException("Do not use queuing with " + getClass().getSimpleName());
    }

    public ButtonBorder removeFromBorder(final Component child) {
        super.remove(child);
        return this;
    }

    public ButtonBorder replaceInBorder(final Component component) {
