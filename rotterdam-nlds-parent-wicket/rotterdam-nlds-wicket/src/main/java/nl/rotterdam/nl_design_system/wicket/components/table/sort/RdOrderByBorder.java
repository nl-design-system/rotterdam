 ...
 * 
 */
public class RdOrderByBorder<S> extends Border
{
	 ...
	 * @param id
	 *            see
	 *            {@link OrderByLink#OrderByLink(String, Object, ISortStateLocator) }
	 * @param property
	 *            see
	 *            {@link OrderByLink#OrderByLink(String, Object, ISortStateLocator) }
	 * @param stateLocator
	 ...
	 *            {@link OrderByLink#OrderByLink(String, Object, ISortStateLocator) }
	 */
	public RdOrderByBorder(final String id, final S property,
						   final ISortStateLocator<S> stateLocator)
	{
        ...
        Form<Void> sortByThisPropertyButtonEnclosedInForm = new Form<>("sortForm") {
            ...
            protected void onInitialize() {
                super.onInitialize();
                add(newOrderByButton("orderByButton", property, stateLocator));
            }
        };



        addToBorder(sortByThisPropertyButtonEnclosedInForm);
	}
	 ...
	 * @return link
	 */
	protected RdOrderByButton<S> newOrderByButton(final String id, final S property,
                                                  final ISortStateLocator<S> stateLocator)
	{
