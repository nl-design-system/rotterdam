            ...
            <dialog id="dialog2" class="ams-dialog">
                <div id="content1">
                    <header class="ams-dialog__header">
                        ...
                        <button name="dialog:content:closeButton" id="closeButton3" class="ams-icon-button"><span class="ams-visually-hidden">Close</span><span class="ams-icon ams-icon--square ams-icon--heading-%s"><rods-icon-close></rods-icon-close></span></button>
                    </header>
            ...
            <dialog id="dialog2" class="ams-dialog">
                <div id="content1">
                    <header class="ams-dialog__header">
                        ...
                        <button name="dialog:content:closeButton" id="closeButton3" class="ams-icon-button"><span class="ams-visually-hidden">Close button label</span><span class="ams-icon ams-icon--square ams-icon--heading-1"><rods-icon-close></rods-icon-close></span></button>
                    </header>
                    <div class="ams-dialog__body">Content</div>
                    <footer class="ams-dialog__footer">
                        <div>Footer</div>
