...
public class ExamplePanel extends Panel {
    ...
    private Component createComponent() {
        return new UtrechtHeading("headingDefaultModel", 3).setDefaultModel(Model.of("Text via defaultModel"));
    }
