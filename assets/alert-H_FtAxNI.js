...
public class ExamplePanel extends Panel {
    ...
    private Component createComponent() {
        return new UtrechtAlert("alertError", Model.of("Deze gegevens zijn reeds ingevuld en komen uit Basis Registratie Personen (BRP). Indien deze gegevens niet kloppen, kunt u dit wijzigen in het BRP."), UtrechtAlertType.ERROR);
    }
...
public class ExamplePanel extends Panel {
    ...
    private Component createComponent() {
        return new UtrechtAlert("alertInfo", Model.of("Deze gegevens zijn reeds ingevuld en komen uit Basis Registratie Personen (BRP). Indien deze gegevens niet kloppen, kunt u dit wijzigen in het BRP."), UtrechtAlertType.INFO);
    }
...
public class ExamplePanel extends Panel {
    ...
    private Component createComponent() {
        return new UtrechtAlert("alertOk", Model.of("Deze gegevens zijn reeds ingevuld en komen uit Basis Registratie Personen (BRP). Indien deze gegevens niet kloppen, kunt u dit wijzigen in het BRP."), UtrechtAlertType.OK);
    }
...
public class ExamplePanel extends Panel {
    ...
    private Component createComponent() {
        return new UtrechtAlert("alertWarning", Model.of("Deze gegevens zijn reeds ingevuld en komen uit Basis Registratie Personen (BRP). Indien deze gegevens niet kloppen, kunt u dit wijzigen in het BRP."), UtrechtAlertType.WARNING);
    }
...
`,e.jsx(a,{children:l})]})}function h(n={}){const{wrapper:t}={...r(),...n.components};return t?e.jsx(t,{...n,children:e.jsx(i,{...n})}):i()}export{h as default};
